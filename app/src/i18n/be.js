export default {
    ...
    // initial note
    "initial-note-title": "Прывітанне! Трохі карыснай інфармацыі для працы з праграмай",
    "initial-note-ci-1": "Сардэчна запрашаем у дадатак \"Штодзённік\". Націсніце на заметку што-б убачыць поўнае ўтрыманне.",
    ...
    "initial-note-ci-18": "Прыемнага карыстання!",
