export default {
    ...
    "finished-notes-notifications": "Выводзіць апавяшчэнні для завершаных задач",
    "auto-move-not-completed": "Пры змене даты аўтаматычна перамяшчаць незавершаныя задачы на сёння",
    ...
    "initial-note-ci-14": "Для перамяшчэння зацісніце яе на кароткі час у правай частцы (у раёне кнопак 'Завяршыць' і 'Опцыі') і перацягнуць на патрэбную пазіцыю",
    ...
    "initial-note-ci-21": "Прысутнічае магчымасць аўтаматычнага пераносу незавершаных задач на наступны дзень",
    ...
    "updates-note-ci-2": "Дададзена перасоўванне нататак ўручную. Для перамяшчэння зацісніце яе на кароткі час у правай частцы (у раёне кнопак 'Завяршыць' і 'Опцыі') і перацягнуць на патрэбную пазіцыю.",
    ...
    // update note v1.8
    "updates-v1.8-note-title": "Версія 1.8. Абнаўлення",
    "updates-v1.8-note-ci-1": "Дададзеная кнопка 'Перанесці на заўтра'",
    "updates-v1.8-note-ci-2": "Дададзеная магчымасць выдзялення тэксту",
    "updates-v1.8-note-ci-3": "Зменены спосаб перацягвання нататак. Для перамяшчэння зацісніце яе на кароткі час у правай частцы (у раёне кнопак 'Завяршыць' і 'Опцыі') і перацягнуць на патрэбную пазіцыю",
    "updates-v1.8-note-ci-4": "Выпраўленая памылка пры спробе ўвайсці праз Google акаўнт",
