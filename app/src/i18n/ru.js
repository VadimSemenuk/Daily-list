export default {
    ...
    // meta
    "re-enter-request-description": "Пожалуйста, произведите резервное копирование повтороно что бы работать с сохраненными данными в текущей версии приложения.",
    "re-enter-discard-button": "Больше не показывать",
    "no-backup-notification": "У Вас включено автоматическое резервное копирование но оно не выполнялось более 30 дней. Рекомендуем подключиться к интернету и выполнить резервное копирование вручную или перезапустить приложение для выполнения автоматического резервного копирования.",
