export default {
    ...
    "en": "English",
    "be": "Беларускі",
    "notes-count": "Счетчик заметок на календаре",
    ...
    "pass-in": "Введите пароль",
    "not-equal-passwords": "Пароли в полях не совпадают",
    "no-space-password": "В пароле нельзя использовать пробел",
    ...
    "password-has-been-reset": "Новый пароль отправлен на адрес {{email}}. Проверьте папку \"Спам\" если письмо не найдено",
    ...
    "no-notification": "Не приходят уведомления",
    "no-notification-description": `Перейдите в настройки приложения в системе: Настройки -> Приложения -> Ежедневник.
    ...
    // initial note
    "initial-note-title": "Добро пожаловать! Немного полезной информации для работы с программой",
    "initial-note-ci-1": "Нажмите на заметку что-бы увидеть полное содержание.",
    "initial-note-ci-2": "Заметка может содержать в себе:",
    "initial-note-ci-3": "Обычный текст",
    "initial-note-ci-4": "Список",
    "initial-note-ci-5": "Пункт 1",
    "initial-note-ci-6": "Пункт 2",
    "initial-note-ci-7": "Пункт 3",
    "initial-note-ci-8": "Изображение. Для увеличения изображения нажмите на него",
    "initial-note-ci-9": "Также для заметки можно добавить:",
    "initial-note-ci-10": "Цветовую метку",
    "initial-note-ci-11": "Ярлыки",
    "initial-note-ci-12": "Напоминание",
    "initial-note-ci-13": "Автоматическое повторение",
    "initial-note-ci-14": "Для перемещения заметки зажмите ее на короткое время и затем перетащите на нужную позицию",
    "initial-note-ci-15": "В приложении реализовано две панели.",
    "initial-note-ci-16": "На панели \"Ежедневник\" заметки создаются с привязкой к дате и отображаются для выбранной на календаре даты. \n"
        + "Для смены дня нажмите дату на календаре или свайпните влево или вправо панель со списком заметок. Нажмите на стрелку для отображения развернутого календаря. \n"
        + "Свайпните календарь для показа других дат",
    "initial-note-ci-17": "На панели \"Заметки\" заметки создаются без привязки к дате.",
    "initial-note-ci-18": "Нажмите на дату над календарем для перехожа на текущий день.",
    "initial-note-ci-19": "Присутствует возможность добавления виджета приложения на главный экран.",
    "initial-note-ci-20": "Приятного пользования!",

    // initial tags
    "initial-tag-1": "Работа",
    "initial-tag-2": "Покупки",
    "initial-tag-3": "Идеи",

    // updates note
    "updates-note-title": "Версия 1.7. Обновления.",
    "updates-note-ci-1": "Добавлены ярлыки.",
    "updates-note-ci-2": "Добавлено перемещение заметок вручную. Для перемещения заметки зажмите ее на короткое время и затем перетащите на нужную позицию.",
    "updates-note-ci-3": "Добавлены панели \"Ежедневник\" и \"Заметки\". \n"
        + "На панели \"Ежедневник\" заметки создаются с привязкой к дате и отображаются для выбранной на календаре даты. \n"
        + "На панели \"Заметки\" заметки создаются без привязки к дате.",
    "updates-note-ci-4": "Добавлена корзина",
    "updates-note-ci-5": "Добавлен поиск заметок",
    "updates-note-ci-6": "Добавлено автоматическое резервное копирование",
    "updates-note-ci-7": "Добавлена возможность сбросса пароля",
    "updates-note-ci-8": "Добавлена возможность добавления виджета приложения на главный экран.",
