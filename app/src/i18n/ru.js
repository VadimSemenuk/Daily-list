export default {
    ...
    // initial note
    "initial-note-title": "Привет! Немного полезной информации для работы с программой",
    "initial-note-ci-1": "Добро пожаловать в приложение \"Ежедневник\". Нажмите на заметку что-бы увидеть полное содержание.",
    ...
    "initial-note-ci-18": "Приятного пользования!",
